      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">Quickly calculate price per gram for any product in your list.</p>
          </div>
        </div>
            ...
            <div className="p-3 max-h-[480px] overflow-y-auto space-y-2">
              ...
              {!loading && products.map(p => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-3 rounded-md transition-colors text-left ${selectedId === p.id ? 'bg-amber-50 ring-1 ring-amber-200' : 'hover:bg-slate-50'}`}
                >
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <select
                      value={unit}
                      onChange={(e) => setUnit(e.target.value as 'g' | 'kg' | 'ml' | 'l')}
                  ...
                  <div className="text-xs text-slate-400 mt-2">Enter the total amount for the product ({inputDescription}).</div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    min={0}
                  />
                  <div className="text-xs text-slate-400 mt-2">If you paid a different price, enter it here.</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 border flex items-center justify-between">
              ...
              <div className="flex flex-col items-end gap-3">
                ...
                <div className="text-xs text-slate-400">Tip: use small amounts for higher precision.</div>
              </div>
            </div>
          </div>
        </div>
